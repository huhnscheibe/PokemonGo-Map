...
def search(args, i):
	...
	if api._auth_provider and api._auth_provider._ticket_expire:
		for ticket in api._auth_provider.get_ticket():
			if type(ticket) == int:
				ticket_expire = ticket
				break
		else:
			ticket_expire = time.time()
		remaining_time = ticket_expire/1000 - time.time()
